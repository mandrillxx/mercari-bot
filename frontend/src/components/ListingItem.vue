    ...
    <div class="flex flex-wrap">
      <div class="w-3/12">
        <div class="flex flex-col m-3">
          <a :href="`https://mercari.com${listing.offers.url}`" target="_blank">
            <img
              class="rounded-lg"
      ...
      <div class="w-4/12">
        <div class="flex-1 align-middle place-items-center">
          ...
          <div class="flex justify-center place-items-center mt-[25px]">
            ...
            <span class="text-white text-lg ml-1 font-medium">{{
              listing.username
            }}</span>
            <span class="text-[#5356ee] text-lg font-medium ml-1">{{
              listing.reviews
            }}</span>
          </div>
